...
namespace Wallet.Core.Services
{
    public class TransactionService : ITransactionService
    {
        ...
        public async Task<ExecutionResponse<UserTransactionDto>> CreateWalletToWalletTransactionAsync(Guid senderWalletId, 
            Guid receiverWalletId, int amount, string description)
        {
            if(amount <= 0)
        ...
        public async Task<PagedExecutionResponse<IEnumerable<UserTransactionDto>>> GetTransactionsForWallet(Guid id, int pageNumber, int pageSize, DateTime searchDate)
        {
