        ...
        <div style={{border: '1px solid grey', height: 'calc(100% - 2rem)', paddingTop: '1rem' , margin: '1rem 1rem 0'}}>
            ...
            <div>
                <div style={{ display: 'flex', padding: '1rem' }}>
                    ...
                    <div style={{ flex: '4', height: '26px', padding: '1.6rem', margin: '0rem 1rem 1rem 1rem', border: '1px solid grey', borderRadius: '10px' }}>
                        <svg width="26" height="27px" viewBox="0 0 26 23" fill="none" xmlns="http://www.w3.org/2000/svg">
